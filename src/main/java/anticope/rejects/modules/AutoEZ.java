...
public class AutoEZ extends Module {
    ...
    public AutoEZ() {
        super(MeteorRejectsAddon.CATEGORY, "auto-ez", "(stolen code) When you kill somebody, you gotta mack em!");
    }

    public AutoEZ(Category category, String name, String description) {
