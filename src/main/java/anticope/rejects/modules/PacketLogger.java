// code not mine; stolen from https://github.com/Cr7mbl3/meteor-packet-logger/blob/master/src/main/java/me/cr7mbl3/packetlogger/modules/PacketLogger.java
...
public class PacketLogger extends Module {
    ...
    public PacketLogger() {
        super(MeteorRejectsAddon.CATEGORY, "packet-logger", "Logs specific packets to console.");
    }
    ...
    private void log(String prefix, Packet<?> packet) {
        MeteorRejectsAddon.LOG.info("Packet {} {}", prefix, packetToString(packet));
    }
