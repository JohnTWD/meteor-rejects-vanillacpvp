...
// stolen from https://github.com/etianl/Trouser-Streak/blob/main/src/main/java/pwn/noobs/trouserstreak/modules/NewerNewChunks.java#L47
...
public class NewerNewChunks extends Module {
    ...
    public NewerNewChunks() {
        super(MeteorRejectsAddon.CATEGORY, "NewerNewChunks", "Estimates new chunks by checking liquid flow, and by using block ticking packets.");
    }
