...
// stolen code from https://github.com/unnamedlife/bbcware/blob/main/src/main/java/bbcdevelopment/addon/bbcaddon/modules/combat/QuickMend.java#L25
...
public class AutoMend extends Module {
    ...
    public AutoMend(){
        super(MeteorRejectsAddon.CATEGORY, "AutoMend", "Useful for robots whos only skill is sitting in a hole 24/7");
    }
    int oDel = 0;
    @EventHandler
